...
/* package SiteHaskell-0.0.0 */
#define VERSION_SiteHaskell "0.0.0"
#define MIN_VERSION_SiteHaskell(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  0 || \
...
#define CURRENT_COMPONENT_ID "SiteHaskell-0.0.0"

#define CURRENT_PACKAGE_KEY "SiteHaskell-0.0.0"
